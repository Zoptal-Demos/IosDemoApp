...
class CustomAlert {
    static func showAlert(with message: String, title: String? = "MUNZUL", in viewController: UIViewController, completion: (() -> Void)? = nil) {
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "OK", style: .default) { _ in
            completion?() // Call the completion block when OK is clicked
        })
